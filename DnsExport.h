...
class DnsExport {
    public:
        ...
        std::string decode_dns_record(int record_type, int data_length, int *record_length, unsigned char *record_payload, unsigned char *buffer);
        ...
        virtual unsigned char *parse_transport_protocol(const unsigned char* packet, unsigned offset, u_int8_t protocol, bool tcp_parse);
